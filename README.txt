...
All credit card applications are recorded in the log file log.txt in the top-level CardPreQualificationTool folder.
...
file (.sln) in Visual Studio and run it (Debug -> Start Without Debugging, or Ctrl-F5).
